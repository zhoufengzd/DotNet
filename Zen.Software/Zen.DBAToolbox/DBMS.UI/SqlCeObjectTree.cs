...
namespace Zen.DBAToolbox
{
    ...
    public sealed class SqlCeObjectTree : DBTableViewTree
    {
        public SqlCeObjectTree(IDataProvider<DataTable> tblProvider)
            :this(tblProvider, TableGroupbyColumns, TableNameColumn)
        {
        }

        public SqlCeObjectTree(IDataProvider<DataTable> tblProvider, IEnumerable<string> indexColumns, string leafColumn)
