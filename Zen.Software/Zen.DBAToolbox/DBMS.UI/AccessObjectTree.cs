...
namespace Zen.DBAToolbox
{
    ...
    public sealed class AccessObjectTree : DBTableViewTree
    {
        public AccessObjectTree(IDataProvider<DataTable> tblProvider)
            :this(tblProvider, TableGroupbyColumns, TableNameColumn)
        {
        }

        public AccessObjectTree(IDataProvider<DataTable> tblProvider, IEnumerable<string> indexColumns, string leafColumn)
